package ir.instapack.android.LoginSignUp.Intro;
...
public class IntroActivity extends BaseActivity {
    ...
    private String about_description_array[] = {
            "مطمئن باشید که اطلاعات حساب شما در جایی ذخیره نخواهد شد و شما مستقیماً در اینستاگرام لاگین می\u200Cکنید.",
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current < MAX_STEP) {
                    ...
                    startActivity(new Intent(IntroActivity.this, LoginToAppActivity.class));
                    finish();
                }
            }
        });
    ...
    private void bottomProgressDots(int current_index) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setColorFilter(getResources().getColor(R.color.colorGrayText), PorterDuff.Mode.SRC_IN);
