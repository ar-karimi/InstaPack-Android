...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((ir.instapack.android.services.main.profileTab.ProfileViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable ir.instapack.android.services.main.profileTab.ProfileViewModel ViewModel) {
